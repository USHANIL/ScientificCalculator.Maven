...
public class Calculator
{
    ...
    public void getTwoNumbers()
    {
         ...
         firstNumber = Double.valueOf(Console.getIntegerInput("Enter First Number"));
         secondNumber = Console.getDoubleInput("Enter Second Number");

    }
    public void getOneNumber()
    {
         firstNumber = Double.valueOf(Console.getIntegerInput("Enter a Number"));
    }
    ...
    //find exponent
    /*
    public static String expo(double x) {
        return String.valueOf(Math.getExponent(x));
    }
     */
}
